...
![Filtrowanie danych](Zdjęcia/Zad1/4.png)
...
![Rozkład klas](Zdjęcia/Zad1/7.png)
...
![Wyniki HerBERT baseline](Zdjęcia/Zad2/4.png)
...
1. Sam wynik dokładności (Accuracy = 76%) wygląda nieźle, ale to zasługa tego, że model świetnie radzi sobie z wyłapywaniem minusów i plusów. Niestety, kompletnie niedaje rady z klasami neutralnymi.

2. Model ma dużą tendencję do wrzucania wszystkiego, co neutralne, do worka z plusami (zrobił tak aż 95 razy na 117). Wystarczy, że tekst jest pisany suchym, medycznym lub technicznym językiem, a model uznaje to za coś pozytywnego, mimo że nie ma tam żadnych emocji.
...
Przeprowadzono dwa rodzaje eksperymentów zgodnie z wymaganiami listy.
...
![HerBERT sentiment](Zdjęcia/Zad3/8.png)

![Finance sentiment](Zdjęcia/Zad3/5.png)

Model **fine-tuned na recenzjach** osiąga prawie **dwukrotnie lepszą accuracy** niż model z domeny finansowej. Model finansowy ma wysoką precyzję dla minus (0,90), ale bardzo niską czułość (0,28) — dominuje klasyfikacja jako neutral (210 z 300 przypadków minus → neutral).

**Wniosek:** Model finansowy nie generalizuje na recenzje medyczne/hotelowe.
...
![max_length=128](Zdjęcia/Zad3/6.png)

![max_length=256](Zdjęcia/Zad3/7.png)

![max_length=512](Zdjęcia/Zad3/8.png)

- **max_length=256** daje najlepszą accuracy (0,7622).
- **max_length=128** daje najlepszy F1 macro (0,6405) — nieznacznie lepszy recall dla neutral.
- Różnice między wartościami są **niewielkie** (<2 pp accuracy) — model jest dość odporny na długość kontekstu w tym zakresie.

### 6.3. Tabela porównawcza

![Tabela porównawcza](Zdjęcia/Zad3/9.png)

### 6.4. Wnioski

1. **Model z tej samej domeny** (recenzje) radzi sobie znacznie lepiej niż model z innej domeny (finanse).
2. Parametr **max_length** ma marginalny wpływ — optymalna wartość to **256 tokenów**.
3. We wszystkich konfiguracjach **klasa neutral pozostaje najtrudniejsza**.
...
![Liczba próbek](Zdjęcia/Zad4/1.png)

**Ładowanie modelu**

![Konfiguracja pipeline](Zdjęcia/Zad4/2.png)

**Prompt bazowy** — ścisła instrukcja + spacja po `Class: ` wymuszająca jednowyrazową odpowiedź:

![Prompt i łańcuch LangChain](Zdjęcia/Zad4/3.png)
...
![Funkcja classify_with_llm](Zdjęcia/Zad4/4.png)

### 7.2. Wyniki ewaluacji

![Wyniki Qwen LLM](Zdjęcia/Zad4/6.png)
...
![Podgląd surowych odpowiedzi](Zdjęcia/Zad4/5.png)
...
![Liczba próbek](Zdjęcia/Zad5/1.png)
...
![Definicje promptów](Zdjęcia/Zad5/2.png)
...
![Eksperyment temperatury](Zdjęcia/Zad5/3.png)
...
![Eksperyment promptu](Zdjęcia/Zad5/4.png)
...
![Eksperyment JSON](Zdjęcia/Zad5/5.png)
...
![Tabela porównawcza zadanie 5](Zdjęcia/Zad5/6.png)
