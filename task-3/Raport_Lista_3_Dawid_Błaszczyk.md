...
1. [Wstęp teoretyczny](#1-wstęp-teoretyczny)
  - [1.1. Czym jest PDDL?](#11-czym-jest-pddl)
  - [1.2. Model STRIPS](#12-model-strips)
2. [Zadanie 1 — Transport intermodalny paczek (25 pkt)](#3-zadanie-1--transport-intermodalny-paczek-25-ptk)
  - [3.1. Model logiczny — domena](#31-model-logiczny--domena)
  - [3.2. Opis problemu](#32-opis-problemu)
  - [3.3. Topologia sieci transportowej](#33-topologia-sieci-transportowej)
  - [3.4. Wynik planera](#34-wynik-planera)
  - [3.5. Analiza planu](#35-analiza-planu)
3. [Zadanie 2 — Robot odkurzający (15 pkt)](#4-zadanie-2--robot-odkurzający-15-ptk)
  - [4.1. Opis problemu](#41-opis-problemu)
  - [4.2. Plik domain.pddl](#42-plik-domainpddl)
  - [4.3. Plik problem.pddl](#43-plik-problempddl)
  - [4.4. Wygenerowany plan](#44-wygenerowany-plan)
  - [4.5. Analiza](#45-analiza)
4. [Zadanie 3 — Robot z dwoma ramionami (10 pkt)](#5-zadanie-3--robot-z-dwoma-ramionami-10-ptk)
  - [5.1. Opis problemu](#51-opis-problemu)
  - [5.2. Domena i problem (zgodne z listą)](#52-domena-i-problem-zgodne-z-listą)
  - [5.3. Wygenerowany plan](#53-wygenerowany-plan)
  - [5.4. Analiza planu](#54-analiza-planu)
5. [Porównanie eksperymentów](#6-porównanie-eksperymentów)
6. [Wnioski końcowe](#7-wnioski-końcowe)
